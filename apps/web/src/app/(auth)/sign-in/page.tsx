      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[var(--color-ink-4)] mt-1">
            Practice high-stakes conversations with trained actors.
          </p>
        </div>

        {/* Card */}
        <div
          className="bg-[var(--color-paper)] border border-[var(--color-line)] rounded-[var(--radius-auth-lg)] p-6 shadow-sm"
        >
